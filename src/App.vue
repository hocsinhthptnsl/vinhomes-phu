<template>
  <div id="app">
    ...
    <Footer></Footer>
    <div>
      <button class="hotline">Hotline: 0945.505.885
    ...
    <div class="p-1" style="background-color:#304658; text-align: center; color:  #ffffff">Copyright 2019 © Vinhomes Smart City Tây Mỗ</div>
