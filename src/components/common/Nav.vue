        ...
        <nav class="navbar navbar-expand-lg navbar-light nav-custom">
            ...
            <div class="collapse navbar-collapse" id="navbarNav" style="justify-content: flex-start">
                <ul class="nav nav-pills nav-padding">
                    ...
                    <li class="nav-item">
                        <router-link class="nav-link" :class="{ active: isActive('matbang') }" @click.native="closeToggle('matbang')" to="/mat-bang">TIỆN ÍCH</router-link>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <router-link class="nav-link" :class="{ active: isActive('canhomau') }" @click.native="closeToggle('canhomau')" to="/can-ho-mau"><span>TIẾN ĐỘ XÂY DỰNG</span></router-link>
                    </li>
                  <!--  <li class="nav-item">
